  ...
  head: () => ({
    meta: [
      ...
      { title: "CareerGraph — Career intelligence for institutions" },
      {
        name: "description",
        content:
          "CareerGraph maps student skills, roadmaps and placement outcomes into one editorial career-intelligence workspace.",
      },
      { name: "author", content: "CareerGraph" },
      { property: "og:title", content: "CareerGraph — Career intelligence for institutions" },
      {
        property: "og:description",
        content:
          "Skill graphs, roadmaps, opportunities and placement analytics for students, faculty, seniors and administrators.",
      },
